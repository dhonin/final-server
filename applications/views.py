...
# from profiles.models import Profile   # adjust if your Profile model is elsewhere
...
#             is_auto_apply=False,
#             manual_answers=serializer.validated_data,
#             status='pending'
#         )

#         # Snapshot profile data (if exists)
...
class ApplyAutoView(generics.GenericAPIView):
    ...
    def post(self, request, job_id):
        ...
        snapshot_skills = profile.skills if profile and hasattr(profile, 'skills') else []
        ...
        application = JobApplication.objects.create(
            ...
            snapshot_experience=snapshot_experience
        )
